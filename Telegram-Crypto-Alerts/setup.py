...
parser.add_argument('--coins', nargs='+', type=str, required=True,
                    help='Enter every coin you want to alert.')
...
try:
    ...
    UserConfiguration(user_id).whitelist_user(args.coins, is_admin=True)
